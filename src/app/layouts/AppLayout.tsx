      ...
      <header className="sticky top-0 z-30 border-b bg-white/95 backdrop-blur shadow-xs">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            {eventName && (
              <span className="hidden md:inline-flex items-center rounded-full bg-amber-500/10 border border-amber-500/20 px-2.5 py-0.5 text-xs font-semibold text-amber-800 dark:text-amber-300">
                {eventName}
              </span>
            )}
          </div>
