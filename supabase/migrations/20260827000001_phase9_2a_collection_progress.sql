-- ==============================================================================
-- Migration: 20260827000001_phase9_2a_collection_progress.sql
-- Phase 9-2A: Backend Collection Progress & Building Traversal Foundation
-- ==============================================================================

-- ------------------------------------------------------------------------------
-- 1. RPC: get_event_building_summaries (Lightweight Continue Collection Summaries)
-- ------------------------------------------------------------------------------
...
BEGIN
    ...
    -- Step A: Pre-aggregate receipts per property (eliminates 1:N join multiplication)
...
-- ------------------------------------------------------------------------------
-- 2. RPC: get_building_properties_progress (Active Building Flat Grid)
-- ------------------------------------------------------------------------------
...
BEGIN
    ...
    -- 5. Safe per-property receipt and follow-up aggregation for this building
    WITH property_receipts AS (
        SELECT
            r.property_id,
            COUNT(r.id) AS receipt_count,
