-- ==============================================================================
-- Migration: 20260829000026_phase9_3c_require_discrepancy_reason.sql
-- Phase 9-3C: Enforce server-side discrepancy reason validation on shortages
-- ==============================================================================
...
BEGIN
    ...
    IF v_difference < 0 THEN
        IF p_discrepancy_reason IS NULL OR LENGTH(TRIM(p_discrepancy_reason)) < 3 THEN
            RAISE EXCEPTION 'A discrepancy reason of at least 3 characters is required when there is a physical collection shortage.';
        END IF;
